...
public class OptimizedEventManager implements Listener {
    ...
    private Class<? extends Event> getEventClass(ru.openhousing.coding.blocks.events.PlayerEventBlock.PlayerEventType eventType) {
        return switch (eventType) {
            ...
            case DAMAGE -> org.bukkit.event.entity.EntityDamageEvent.class;
            case DEATH -> PlayerDeathEvent.class;
            case RESPAWN -> PlayerRespawnEvent.class;
            case DROP_ITEM -> PlayerDropItemEvent.class;
            case PICKUP_ITEM -> org.bukkit.event.entity.EntityPickupItemEvent.class;
            case INVENTORY_CLICK -> org.bukkit.event.inventory.InventoryClickEvent.class;
            ...
            case BREAK_BLOCK -> org.bukkit.event.block.BlockBreakEvent.class;
            case PLACE_BLOCK -> org.bukkit.event.block.BlockPlaceEvent.class;
            default -> null;
        };
    }
}
